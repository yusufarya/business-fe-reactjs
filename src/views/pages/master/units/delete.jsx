...
const ModalDelete = ({status, onModalStatusChange, paramsUnit, successUpdate}) => {
    console.log(paramsUnit)
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await AppService.serviceDelete('api/unit/delete', {id:paramsUnit.id})
    ...
    return (
        <>
            ...
            <CModalHeader onClose={handleClose}>
				<CModalTitle id="LiveDemoExampleLabel">Delete Data Unit</CModalTitle>
			</CModalHeader>
            <CForm onSubmit={handleSubmit}>
                <CModalBody>
                    Delete data {paramsUnit.name} ?
                </CModalBody>
				<CModalFooter>
