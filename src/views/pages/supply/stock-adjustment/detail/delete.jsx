...
const ModalDelete = ({status, onModalStatusChange, paramsWarehouse, successUpdate}) => {
    console.log(paramsWarehouse)
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await AppService.serviceDelete('api/warehouse/delete', {id:paramsWarehouse.id})
    ...
    return (
        <>
            ...
            <CModalHeader onClose={handleClose}>
				<CModalTitle id="LiveDemoExampleLabel">Delete Data Warehouse</CModalTitle>
			</CModalHeader>
            <CForm onSubmit={handleSubmit}>
                <CModalBody>
                    Delete data {paramsWarehouse.name} ?
                </CModalBody>
				<CModalFooter>
